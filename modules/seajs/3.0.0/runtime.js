...
!(function(a, b) {
  ...
  function f(a) {
    for (a = a.replace(C, "/"), a = a.replace(E, "$1/"); a.match(D); )
      a = a.replace(D, "/");
    return a;
  }
  function g(a) {
  ...
  function i(a) {
    var b = t.paths,
      c;
    return b && (c = a.match(F)) && v(b[c[1]]) && (a = b[c[1]] + c[2]), a;
  }
  function j(a) {
    var b = t.vars;
    return (
  ...
  function p(a, b, c) {
    ...
    q(d, b, a),
      ...
      (d.src = a),
      (_ = d),
      $ ? Z.insertBefore(d, $) : Z.appendChild(d),
      (_ = null);
  }
  function q(a, b, c) {
    function d(c) {
      (a.onload = a.onerror = a.onreadystatechange = null),
        t.debug || Z.removeChild(a),
        (a = null),
        b(c);
    }
    var e = "onload" in a;
  ...
  if (!a.seajs) {
    ...
    var J =
      ...
      L,
      M,
      N = !location.href || K.test(location.href) ? "" : e(location.href);
    if (J) {
      var O;
      try {
        var P = Error();
      ...
      for (
        var R,
          S = /.*?((?:http|https|file)(?::\/{2}[\w]+)(?:[\/|\.]?)(?:[^\s"]*)).*?/i,
          T = /(.*?):\d+:\d+\)?$/;
        O.length > 0;

      ) {
        var U = O.shift();
        if (((R = S.exec(U)), null != R)) break;
      }
      var V;
      if (null != R) var V = T.exec(R[1])[1];
      (M = V), (L = e(V || N)), "" === N && (N = L);
    } else {
      var W = document,
        X = W.scripts,
        Y = W.getElementById("seajsnode") || X[X.length - 1];
      (M = n(Y)), (L = e(M || N));
    }
    if (J) s.request = o;
    else {
      var W = document,
        Z = W.head || W.getElementsByTagName("head")[0] || W.documentElement,
    ...
    (r.prototype.resolve = function() {
      ...
      (r.prototype.load = function() {
        ...
        if (!(a.status >= fb.LOADING)) {
          ...
          for (d = 0; e > d; d++)
            (g = ab[c[d]]),
              g.status < fb.FETCHING
                ? g.fetch(f)
                : g.status === fb.SAVED && g.load();
      ...
      (r.prototype.error = function() {
        var a = this;
        a.onload(), (a.status = fb.ERROR);
      }),
      (r.prototype.exec = function() {
        function a(b) {
          var d = c.deps[b] || r.get(a.resolve(b));
          if (d.status == fb.ERROR) throw Error("module was broken: " + d.uri);
          return d.exec();
        }
        var c = this;
        if (c.status >= fb.EXECUTING) return c.exports;
        if (
          ((c.status = fb.EXECUTING),
        ...
        var f = c.factory,
          g = x(f) ? f(a, (c.exports = {}), c) : f;
        return (
          g === b && (g = c.exports),
          delete c.factory,
          (c.exports = g),
          (c.status = fb.EXECUTED),
          A("exec", c),
          c.exports
        );
      }),
      (r.prototype.fetch = function(a) {
        function c() {
          s.request(g.requestUri, g.onRequest, g.charset);
        }
        function d(a) {
          delete cb[h], (db[h] = !0), bb && (r.save(f, bb), (bb = null));
          var b,
            c = eb[h];
          for (delete eb[h]; (b = c.shift()); ) a === !0 ? b.error() : b.load();
        }
        var e = this,
          f = e.uri;
        e.status = fb.FETCHING;
        var g = { uri: f };
        A("fetch", g);
        var h = g.requestUri || f;
        return !h || db.hasOwnProperty(h)
          ? (e.load(), b)
          : cb.hasOwnProperty(h)
          ? (eb[h].push(e), b)
          : ((cb[h] = !0),
            ...
            A(
              ...
              (g = {
                ...
                requestUri: h,
                onRequest: d,
                charset: x(t.charset) ? t.charset(h) || "utf-8" : t.charset
              })
            ),
      ...
      (r.resolve = function(a, b) {
        var c = { id: a, refUri: b };
        return A("resolve", c), c.uri || s.resolve(c.id, b);
      }),
      (r.define = function(a, c, d) {
        ...
        A("define", f), f.uri ? r.save(f.uri, f) : (bb = f);
      }),
      (r.save = function(a, b) {
        var c = r.get(a);
        c.status < fb.SAVED &&
      ...
      (s.require = function(a) {
        ...
        return b.status < fb.EXECUTING && (b.onload(), b.exec()), b.exports;
      }),
      (t.base = L),
      (t.dir = L),
      (t.loader = M),
