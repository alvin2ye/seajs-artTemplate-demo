!(function() {
  ...
  function c(a, c, e, f) {
    ...
    void 0 !== f && h.setAttribute("crossorigin", f),
      d(h, c, g, a),
      g
        ? ((h.rel = "stylesheet"), (h.href = a))
        : ((h.async = !0), (h.src = a)),
      (p = h),
      t ? s.insertBefore(h, t) : s.appendChild(h),
      (p = null);
  }
  function d(a, b, c, d) {
    function f() {
  ...
  function g(a) {
    for (a = a.replace(y, "/"), a = a.replace(A, "$1/"); a.match(z); )
      a = a.replace(z, "/");
    return a;
  }
  function h(a) {
  ...
  f(o(H) || F),
    (seajs.resolve = n),
    define("seajs/seajs-css/1.0.5/seajs-css", [], {});
})();
